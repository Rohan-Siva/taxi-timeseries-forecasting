...
class TaxiDataPreprocessor:
    ...
    def aggregate_to_hourly(self):
        ...
        full_range = pd.date_range(start=self.hourly_demand.index.min(), end=self.hourly_demand.index.max(), freq='H')
    ...
    def decompose_series(self, period=24):
        ...
        decomposition = seasonal_decompose(self.hourly_demand['trip_count'], model='additive', period=period)
    ...
    def normalize_data(self):
        ...
        self.hourly_demand['trip_count_normalized'] = (self.hourly_demand['trip_count'] - mean) / std
